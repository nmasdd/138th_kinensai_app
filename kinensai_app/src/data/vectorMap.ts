...
export const VECTOR_ROOMS: Record<VectorFloor, VectorRoom[]> = {
  "1階": [
    ...
    { id: "club-27", label: "ステージ", name: "ステージ (晴天時)", x: 810, y: 700, w: 160, h: 190, kind: "outdoor" },
    ...
    { id: "custom-1789366895764", label: "新", name: "新しい部屋", x: 250, y: 510, w: 50, h: 60, kind: "elevator" },
  ...
  "2階": [
    ...
    { id: "club-11", label: "多目的", name: "多目的室", x: 770, y: 240, w: 150, h: 90, kind: "club" },

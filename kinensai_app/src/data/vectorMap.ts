...
export const VECTOR_ROOMS: Record<VectorFloor, VectorRoom[]> = {
  ...
  "2階": [
    ...
    { id: "sys-s2s", label: "1F", name: "南階段 (1Fへ)", x: 690, y: 515, w: 50, h: 50, kind: "stairs" },
  ...
  "3階": [
    ...
    { id: "sys-c3e", label: "", name: "東廊下", x: 830, y: 60, w: 30, h: 450, kind: "corridor" },
    ...
    { id: "sys-s3n", label: "", name: "北東階段", x: 800, y: 60, w: 30, h: 70, kind: "stairs" },

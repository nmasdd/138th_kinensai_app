...
export const VECTOR_ROOMS: Record<VectorFloor, VectorRoom[]> = {
  "1階": [
    ...
    { id: "sys-c1s", label: "", name: "南廊下", x: 80, y: 570, w: 650, h: 30, kind: "corridor" },
    { id: "sys-c1sc", label: "", name: "南中央廊下 (放送室東)", x: 680, y: 370, w: 30, h: 200, kind: "corridor" },
    ...
    { id: "sys-t1p", label: "", name: "中庭前トイレ", x: 800, y: 60, w: 70, h: 70, kind: "toilet" },
    ...
    { id: "sys-s1e", label: "2F", name: "東階段 (2Fへ)", x: 710, y: 400, w: 50, h: 50, kind: "stairs" },
    ...
    { id: "club-27", label: "ステージ", name: "ステージ (晴天時)", x: 850, y: 650, w: 160, h: 190, kind: "outdoor" },
    { id: "custom-1789345451551", label: "入口", name: "入口", x: 730, y: 530, w: 70, h: 110, kind: "hall" },
    { id: "custom-1789345598723", label: "新", name: "新しい部屋", x: 430, y: 600, w: 30, h: 100, kind: "corridor" },
  ],
  "2階": [
    ...
    { id: "sys-h2o", label: "大回廊", name: "大回廊 (講堂・食堂方面)", x: 660, y: 670, w: 70, h: 150, kind: "corridor" },
    { id: "sys-c2ne", label: "", name: "北東廊下 (北廊下の東延長)", x: 680, y: 350, w: 210, h: 30, kind: "corridor" },
    { id: "sys-c2cn", label: "", name: "中央北廊下 (トイレ列北)", x: 680, y: 180, w: 150, h: 30, kind: "corridor" },
    { id: "sys-c2ce", label: "", name: "職員室東廊下", x: 700, y: 380, w: 30, h: 310, kind: "corridor" },
    ...
    { id: "club-20", label: "2学", name: "2階学習室", x: 800, y: 60, w: 70, h: 70, kind: "club" },
    ...
    { id: "sys-h2202", label: "202", name: "202補助教室", x: 80, y: 500, w: 140, h: 70, kind: "hall" },
    ...
    { id: "club-01", label: "スタディーホール", name: "スタディーホール", x: 530, y: 430, w: 170, h: 160, kind: "club" },
    { id: "club-14", label: "205", name: "205補助教室", x: 530, y: 590, w: 120, h: 70, kind: "club" },
    ...
    { id: "custom-1789265676101", label: "", name: "205廊下", x: 530, y: 660, w: 170, h: 30, kind: "corridor" },
  ],
  "3階": [
    ...
    { id: "J2E", label: "2E", name: "中学2E", x: 720, y: 160, w: 130, h: 70, kind: "class" },
    { id: "J2D", label: "2D", name: "中学2D", x: 720, y: 230, w: 130, h: 70, kind: "class" },
    { id: "J2C", label: "2C", name: "中学2C", x: 720, y: 300, w: 130, h: 70, kind: "class" },
    { id: "J2B", label: "2B", name: "中学2B", x: 720, y: 370, w: 130, h: 70, kind: "class" },
    { id: "J2A", label: "2A", name: "中学2A", x: 720, y: 440, w: 130, h: 70, kind: "class" },
    { id: "club-02", label: "工作室", name: "工作室", x: 865, y: 460, w: 55, h: 50, kind: "club" },
    { id: "club-33", label: "美術室", name: "美術室", x: 925, y: 410, w: 75, h: 100, kind: "club" },
    { id: "sys-s3c", label: "階段", name: "中央階段", x: 300, y: 510, w: 70, h: 60, kind: "stairs" },
    { id: "sys-h3301", label: "301", name: "301補助教室", x: 470, y: 510, w: 130, h: 60, kind: "hall" },
    ...
    { id: "sys-ev3w", label: "", name: "中央EV", x: 250, y: 530, w: 50, h: 50, kind: "elevator" },
    { id: "sys-ev3e", label: "", name: "東EV", x: 860, y: 290, w: 30, h: 35, kind: "elevator" },
  ],
  "4階 5階": [
    { id: "sys-c45n", label: "", name: "北廊下", x: 220, y: 30, w: 660, h: 30, kind: "corridor" },
    { id: "sys-c45w", label: "", name: "西廊下 (立入禁止手前まで)", x: 220, y: 60, w: 30, h: 80, kind: "corridor" },
    { id: "sys-c45e", label: "", name: "東廊下", x: 840, y: 60, w: 30, h: 450, kind: "corridor" },
    ...
    { id: "sys-s45n", label: "", name: "北東階段", x: 800, y: 60, w: 35, h: 70, kind: "stairs" },
    { id: "sys-s45w", label: "立入禁止", name: "西階段 (この階まで・立入禁止)", x: 120, y: 170, w: 100, h: 40, kind: "stairs" },
    { id: "sys-s45e", label: "", name: "美術室前階段", x: 840, y: 520, w: 30, h: 50, kind: "stairs" },
    { id: "sys-s45s", label: "", name: "5F階段", x: 420, y: 480, w: 55, h: 40, kind: "stairs" },
    { id: "sys-ev45e", label: "", name: "東EV", x: 872, y: 300, w: 24, h: 35, kind: "elevator" },
  ],
};
